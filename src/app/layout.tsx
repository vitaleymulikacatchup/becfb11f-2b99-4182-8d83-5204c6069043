...
export const metadata: Metadata = {
  title: "Kaleo Live in Concert - Official Event Page",
  description: "Experience Kaleo's powerful rock performance live. Get tickets for this unforgettable concert featuring Iceland's finest musical export.",
  keywords: "Kaleo, concert, live music, rock band, Iceland, tickets, tour",
  metadataBase: new URL("https://kaleomusic.com"),
  alternates: {
    canonical: "https://kaleomusic.com"
  },
  openGraph: {
    title: "Kaleo Live in Concert - Official Event Page",
    description: "Experience Kaleo's powerful rock performance live. Get tickets for this unforgettable concert featuring Iceland's finest musical export.",
    siteName: "Kaleo Concert",
    images: [{
      url: "https://images.pexels.com/photos/811838/pexels-photo-811838.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Kaleo Live in Concert - Official Event Page",
    description: "Experience Kaleo's powerful rock performance live. Get tickets now.",
    images: ["https://images.pexels.com/photos/811838/pexels-photo-811838.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
